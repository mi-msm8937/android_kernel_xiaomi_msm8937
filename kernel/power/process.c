	...
	for_each_process(p) {
		...
		if (!fp_hidl_thawed) {
			if ((!memcmp(p->comm, "android.hardware.biometrics.fingerprint@2.1-service", 52)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_msm8937", 67)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_mi8937", 66)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_land", 64)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_landtoni", 68)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_prada", 65)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_santoni", 67)) ||
				(!memcmp(p->comm,"android.hardware.biometrics.fingerprint@2.1-service.xiaomi_ulova", 65)) ||
